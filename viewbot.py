...
class Main:
    ...
    def solve_captcha(self, sessid):
        try:
            ...
            print(self.format("!", f"Doğrulama | {captcha_answer}"))
        ...
        while True:
            try:
                ...
                if "This service is currently not working" in decryped_answer:
                    ...
                    print(self.format("@", f"Bir Sonraki Gönderime {timer} Saniye Kaldı   "), end="")
                    start = time.time()
                    ...
                    while time.time() < start + timer:
                        ...
                        print(
                            self.format(
                                "@", f"Bir Sonraki Gönderime {round((start + timer) - time.time())} Saniye Kaldı      "
                            ),
                            end="",
                        )
                        time.sleep(1)

                    print(self.format("!", f"1000 Adet Daha İzlenme Göndriliyor..."))
                    continue
